...
PRESS_REGISTRY = {
    ...
    "snapkv": SnapKVPress(),
    "snapkv_w32_k7": SnapKVPress(window_size=32, kernel_size=7),
    ...
    "cam_snapkv": CAMPress(base_press=SnapKVPress()),
    "cam_snapkv_w16_k7": CAMPress(base_press=SnapKVPress(window_size=16, kernel_size=7)),
